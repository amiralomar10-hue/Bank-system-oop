...
{
    clsUtil::Srand();
    cout << clsUtil::RandomOfNumber(1, 10) << endl;
    cout << clsUtil::GetRandomOfNumber(clsUtil::Capitalletter) << endl;
    ...
    clsUtil::ShuffleElementArray(Arr1, 5);
    cout << "\nArray after shuffle:\n";
    for (int i = 0; i < 5; i++)
    {
        cout << Arr1[i] << endl;
    ...
    clsUtil::ShuffleElementArray(Arr2, 5);
    cout << "\nArray after shuffle:\n";
    for (int i = 0; i < 5; i++)
    {
        cout << Arr2[i] << endl;
